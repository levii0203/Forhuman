...
export default function Sidebar(){
    ...
    return (
        <div className={`w-full  h-full m-0 pb-[8vh]  max-w-[260px] border-r-[1px] border-zinc-200 bg-white flex sm:hidden z-[2000]  flex-col py-4 transform transition-transform duration-500 ease-in-out ${sidebar ? 'translate-x-0' : '-translate-x-full'} `}>
            ...
            <div className="flex mt-2 w-full">
                <div className="flex items-center w-full gap-3 mx-[8%] py-2 px-4 cursor-pointer border-[1px] rounded-xl border-white border-[rgba(0,0,0,0.26)]">
